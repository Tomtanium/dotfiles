...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    [ ((mod4Mask,	    xK_l     ), spawn "i3lock-fancy-multimonitor --blur=20x20")

    -- launch a terminal
    , ((modm .|. shiftMask, xK_Return), spawn $ XMonad.terminal conf)

    -- launch dmenu
    , ((modm,               xK_p     ), spawn "dmenu_run -fn 'xft:MesloLGS NF:pixelsize=16:antialias=true:hinting=true'")
...
myStartupHook :: X ()
myStartupHook = do
  spawnOnce "wallpaper-reddit --save"
  spawnOnce "nitrogen --set-zoom-fill --random ~/wallpapers --save &"
  --spawnOnce "xwallpaper --zoom ~/.config/wallpaper.jpg"
  spawnOnce "picom &"
